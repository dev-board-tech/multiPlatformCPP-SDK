 ...
 * @retval SD status
 */
unsigned char GI::Device::Storage::IntMmcSd::BSP_SD_Init(GI::Device::Storage::IntMmcSd *heandler)
{
	...
	if (BSP_SD_IsDetected(heandler) != SD_PRESENT) /* Check if SD card is present */
	{
	...
	if (HAL_SD_Init(&uSdHandle[0], &heandler->uSdCardInfo) != SD_OK)
	{
		sd_state = MSD_ERROR;
	}
	...
	if (sd_state == MSD_OK)
	{
		...
		if (HAL_SD_WideBusOperation_Config(&uSdHandle[0], SDMMC_BUS_WIDE_4B)
				!= SD_OK)
		{
			sd_state = MSD_ERROR;
		}
 ...
 * @retval SD status
 */
unsigned char GI::Device::Storage::IntMmcSd::BSP_SD_DeInit(void)
{
	uint8_t sd_state = MSD_OK;
 ...
 */
unsigned char GI::Device::Storage::IntMmcSd::BSP_SD_IsDetected(GI::Device::Storage::IntMmcSd *heandler)
{
	if(!heandler)
		return 0;
	...
	if (heandler->cardDetectGpio != NULL && heandler->cardDetectGpio->in() != 0)
	{
 ...
 * @retval SD status
 */
unsigned char GI::Device::Storage::IntMmcSd::BSP_SD_ReadBlocks(unsigned long *pData,
 ...
 * @retval SD status
 */
unsigned char GI::Device::Storage::IntMmcSd::BSP_SD_WriteBlocks(unsigned long *pData,
 ...
 * @retval SD status
 */
unsigned char GI::Device::Storage::IntMmcSd::BSP_SD_ReadBlocks_DMA(unsigned long *pData,
		unsigned long long ReadAddr, unsigned long BlockSize,
		unsigned long NumOfBlocks)
{
 ...
 * @retval SD status
 */
unsigned char GI::Device::Storage::IntMmcSd::BSP_SD_WriteBlocks_DMA(unsigned long *pData,
		unsigned long long WriteAddr, unsigned long BlockSize,
		unsigned long NumOfBlocks)
{
	unsigned char sd_state = MSD_OK;
 ...
 * @retval SD status
 */
unsigned char GI::Device::Storage::IntMmcSd::BSP_SD_Erase(unsigned long long StartAddr,
 ...
 */
void GI::Device::Storage::IntMmcSd::BSP_SD_MspInit(SD_HandleTypeDef *hsd, void *Params)
{
	...
	HAL_NVIC_SetPriority((IRQn_Type) SDMMC2_IRQn, 5, 0);
 ...
 * @param  Params : pointer on additional configuration parameters, can be NULL.
 */
void GI::Device::Storage::IntMmcSd::BSP_SD_MspDeInit(SD_HandleTypeDef *hsd, void *Params)
{
	static DMA_HandleTypeDef dma_rx_handle;
	static DMA_HandleTypeDef dma_tx_handle;
 ...
 */
HAL_SD_TransferStateTypedef GI::Device::Storage::IntMmcSd::BSP_SD_GetStatus(void)
{
 ...
 */
void GI::Device::Storage::IntMmcSd::BSP_SD_GetCardInfo(HAL_SD_CardInfoTypedef *CardInfo)
{
	/* Get SD card Information */
	HAL_SD_Get_CardInfo(&uSdHandle[0], CardInfo);
}

void GI::Device::Storage::IntMmcSd::intIoctl(void *heandler, unsigned int command,
		unsigned int *buffer)
{
	if(!heandler)
	{
	...
	GI::Device::Storage::IntMmcSd *_heandler = (GI::Device::Storage::IntMmcSd *)heandler;
...
unsigned int GI::Device::Storage::IntMmcSd::intRead(void *heandler, void *ptr,
...
unsigned int GI::Device::Storage::IntMmcSd::intWrite(void *heandler, void *ptr,
		unsigned long block, unsigned int nblks)
{
	//HAL_SD_CardInfoTypedef *_SDCardInfo = (HAL_SD_CardInfoTypedef *)SdStruct;
	if(!heandler)
...
void GI::Device::Storage::IntMmcSd::intIdle(void *handler)
{
	GI::Device::Storage::IntMmcSd *intHandler = (GI::Device::Storage::IntMmcSd *)handler;
...
/*#####################################################*/
void GI::Device::Storage::IntMmcSd::intGetRawCid(void *handler, unsigned long *rawCid)
{
	GI::Device::Storage::IntMmcSd *intHandler = (GI::Device::Storage::IntMmcSd *)handler;
...
void GI::Device::Storage::IntMmcSd::intGetRawCsd(void *handler, unsigned long *rawCsd)
{
	GI::Device::Storage::IntMmcSd *intHandler = (GI::Device::Storage::IntMmcSd *)handler;
...
GI::Device::Storage::IntMmcSd::IntMmcSd(unsigned int unitNr, char *cardDetectPinPath, char *cardStatusLedPinPath) :
		cardDetected(false)
{
    ...
    idle_Ptr = &GI::Device::Storage::IntMmcSd::intIdle;
    read_Ptr = &GI::Device::Storage::IntMmcSd::intRead;
    write_Ptr = &GI::Device::Storage::IntMmcSd::intWrite;
    ioctl_Ptr = &GI::Device::Storage::IntMmcSd::intIoctl;
    getRawCid_Ptr = &GI::Device::Storage::IntMmcSd::intGetRawCid;
    getRawCsd_Ptr = &GI::Device::Storage::IntMmcSd::intGetRawCsd;
    this->unitNr = unitNr;
    driverHandler_Ptr = (void*)this;
    intIdle(driverHandler_Ptr);
}

GI::Device::Storage::IntMmcSd::~IntMmcSd()
{
}
/******************************************************************************/
