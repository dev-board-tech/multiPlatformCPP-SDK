 ...
 * @retval SD status
 */
unsigned char GI::Device::Storage::IntMmcSd::BSP_SD_Init(GI::Device::Storage::IntMmcSd *handler)
{
 ...
 */
unsigned char GI::Device::Storage::IntMmcSd::BSP_SD_IsDetected(GI::Device::Storage::IntMmcSd *handler)
{
	if(!handler)
		return 0;
...
void GI::Device::Storage::IntMmcSd::intIoctl(void *handler, unsigned int command,
		unsigned int *buffer)
{
	if(!handler)
	{
...
unsigned int GI::Device::Storage::IntMmcSd::intRead(void *handler, void *ptr,
...
unsigned int GI::Device::Storage::IntMmcSd::intWrite(void *handler, void *ptr,
		unsigned long block, unsigned int nblks)
{
	//HAL_SD_CardInfoTypedef *_SDCardInfo = (HAL_SD_CardInfoTypedef *)SdStruct;
	if(!handler)
