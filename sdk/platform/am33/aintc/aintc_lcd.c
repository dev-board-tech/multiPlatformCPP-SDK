...
#include "driver/raster.h"
#include "driver/interrupt.h"
#include "driver/hw/soc_AM335x.h"
/**********************************************/
//extern CfgLcd* ScreenRander;
/**
...
static void LCDIsr(void)
{
    ...
    if (status & RASTER_END_OF_FRAME0_INT_STAT)
    {
        RasterDMAFBConfig(SOC_LCDC_0_REGS,
                (unsigned int)dev.SCREEN[0]->DisplayData,
                (unsigned int)dev.SCREEN[0]->DisplayData + (dev.SCREEN[0]->LcdTimings->X * dev.SCREEN[0]->LcdTimings->Y * sizeof(dev.SCREEN[0]->DisplayData[0])) - 2,
                          0);
    }
