...
void GI::Screen::Gfx::Button::paint(void *pDisplay, s32 x_start, s32 y_start, s32 x_len, s32 y_len, tControlCommandData* control_comand)
{
...
void GI::Screen::Gfx::Button::idle(tControlCommandData* control_comand)
{
	...
	void *pDisplay = (void *)Internals.pDisplay;
	GI::Display::Display* LcdStruct = (GI::Display::Display *) Internals.pDisplay;
					...
					Visible == true)
	{
		...
		Internals.Caption->clone(Caption);
		//change_str(settings->Internals.Caption.Text, settings->Caption.Text);
...
GI::Screen::Gfx::Button::Button(void *parentWindowHandler)
{
	...
	tmp_text = new GI::Screen::Gfx::String(Internals.pDisplay);
...
GI::Screen::Gfx::Button::Button(GI::Display::Display *ScreenDisplay)
{
    if(!this)
		return;
    if(!ScreenDisplay)
