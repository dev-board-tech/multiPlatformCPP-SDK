...
void GI::Screen::Gfx::CheckBox::paint(void *pDisplay, s32 x_start, s32 y_start, s32 x_len, s32 y_len, tControlCommandData* control_comand)
{
...
void GI::Screen::Gfx::CheckBox::idle(tControlCommandData* control_comand)
{
					...
					Visible == true)
	{
		...
		//settings->Internals.Caption.Text = change_str(settings->Internals.Caption.Text.text, settings->Caption.Text);
...
GI::Screen::Gfx::CheckBox::CheckBox(GI::Display::Display *ScreenDisplay)
{
    if(!this)
		return;
	if(!ScreenDisplay)
