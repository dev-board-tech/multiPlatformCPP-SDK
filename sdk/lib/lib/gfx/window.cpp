...
//#######################################################################################
GI::Screen::Gfx::Window::Window(void *parentWindowHandler, GI::Display::Display *screenDisplayHandler)
{
	_newWindow(parentWindowHandler, screenDisplayHandler);
}

GI::Screen::Gfx::Window::Window(GI::Display::Display *screenDisplayHandler)
{
	_newWindow(NULL, screenDisplayHandler);
}

void GI::Screen::Gfx::Window::_newWindow(void *parentWindowHandler, GI::Display::Display *screenDisplayHandler)
{
    if(!this)
		return;
	memset(this, 0, sizeof(*this));
	GI::Screen::Gfx::Window *_parentWindowHandler = (GI::Screen::Gfx::Window *)parentWindowHandler;
	GI::Display::Display *_ScreenDisplay = screenDisplayHandler;
	...
	GI::Screen::Gfx::String *tmp_str = new GI::Screen::Gfx::String(Internals.pDisplay);
	...
	tmp_str = new GI::Screen::Gfx::String(Internals.pDisplay);
...
void* GI::Screen::Gfx::Window::_addChildren(u32 childrenType, char *childrenName, u32 tabIndex)
{
	if(!this)
		return NULL;
	...
	u32 added_children = (u32)Internals.ChildrensNr;
	if(!added_children)
	{
...
//#######################################################################################
void* GI::Screen::Gfx::Window::addChildren(u32 children_type, char *children_name)
{
	return _addChildren(children_type, children_name, 0);
}
//#######################################################################################
void* GI::Screen::Gfx::Window::addChildren(u32 children_type, char *children_name, u32 tab_nr)
{
...
void GI::Screen::Gfx::Window::setChildrens(bool call_childrens, bool transfer_settings, tControlCommandData* control_comand, bool refresh_childrens, ChildrenWindowSize_t *ChildrenWindowSize)
{
	...
	while(Tmp_Children_Cnt < Internals.ChildrensNr && Internals.ChildrensNr != 0)
	{
		...
		{
			u32 children_type = Internals.Childrens[Tmp_Children_Cnt]->Type;
...
void GI::Screen::Gfx::Window::idle(tControlCommandData* control_comand)
{
	...
	if(text_caption_has_changed && !Internals.OldTabGroupMode && Internals.Control.Initiated == true)
	{
		...
		if(Internals.HideHeader == false)
			HeaderSize = Internals.Header.Size.Y;
		u32 header_btn_size = HeaderSize - 6;
		//u32 header_btn_space = HeaderSize - 5;
		tRectangle back_up_clip_header = LcdStruct->sClipRegion;
		s32 _X_StartBox_, _Y_StartBox_, _X_LenBox_, _Y_LenBox_;;
		...
		s32 x_str_location = LcdStruct->sClipRegion.sXMin;
		s32 y_str_location = LcdStruct->sClipRegion.sYMin;
								...
								Internals.Size.ScrollBarSize != Size.ScrollBarSize))
	{
		...
		//settings->Internals.Caption.Text = change_str(settings->Internals.Caption.Text, settings->Caption.Text);
	...
	else
	{
		...
		if(Internals.Header.TabGroupScrollRight->Events.CursorDown || Internals.Header.TabGroupScrollRight->Events.CursorMove)
		{
			...
			u32 len_of_selection_tab = Internals.Header.Size.TabGroupSelectorSize * Internals.Header.TabGroupTabsListNr;
			if(len_of_selection_tab > Internals.Size.X - (header_btn_space * 2) - 2)
			{
				if(Internals.Header.TabGroupSelectorPosition < (s32)(len_of_selection_tab - (Internals.Size.X - (header_btn_space * 2)) - 2))
				{
...
GI::Screen::Gfx::Button *GI::Screen::Gfx::Window::addButton(char *name, u32 tabIndex)
{
	return (GI::Screen::Gfx::Button *)addChildren(WindowButtonChildren, name, tabIndex);
}

GI::Screen::Gfx::CheckBox *GI::Screen::Gfx::Window::addCheckBox(char *name, u32 tabIndex)
{
	return (GI::Screen::Gfx::CheckBox *)addChildren(WindowCheckboxChildren, name, tabIndex);
}

GI::Screen::Gfx::ListBox *GI::Screen::Gfx::Window::addListBox(char *name, u32 tabIndex)
{
	return (GI::Screen::Gfx::ListBox *)addChildren(WindowListboxChildren, name, tabIndex);
}

GI::Screen::Gfx::Picturebox *GI::Screen::Gfx::Window::addPictureBox(char *name, u32 tabIndex)
{
	return (GI::Screen::Gfx::Picturebox *)addChildren(WindowPictureboxChildren, name, tabIndex);
}

GI::Screen::Gfx::TextBox *GI::Screen::Gfx::Window::addTextBox(char *name, u32 tabIndex)
{
	return (GI::Screen::Gfx::TextBox *)addChildren(WindowTextboxChildren, name, tabIndex);
}

GI::Screen::Gfx::ProgressBar *GI::Screen::Gfx::Window::addProgressBar(char *name, u32 tabIndex)
{
	return (GI::Screen::Gfx::ProgressBar *)addChildren(WindowProgressbarChildren, name, tabIndex);
}

GI::Screen::Gfx::KbdQwerty *GI::Screen::Gfx::Window::addKbdQwerty(char *name, u32 tabIndex)
{
	return (GI::Screen::Gfx::KbdQwerty *)addChildren(WindowKbdQwertyChildren, name, tabIndex);
}

GI::Screen::Gfx::Window *GI::Screen::Gfx::Window::addWindow(char *name, u32 tabIndex)
{
	return (GI::Screen::Gfx::Window *)addChildren(WindowWindowChildren, name, tabIndex);
}

GI::Screen::Gfx::Window *GI::Screen::Gfx::Window::addTabGroup(char *name, u32 tabIndex)
{
