...
/*#####################################################*/
void _gui_put_simple_item(s32 x, s32 y, s32 x_size, s32 y_size, u8 fill, u32 color)
{
	s32 radius = sys_def_gui_res.corner_radius;
	if(radius < 0) radius = ~radius;
	s32 a, b, P;
	GI::Display::Display *pDisplay = sys_def_gui_res.pDisplay;
	s32 __x_size = x_size, __y_size = y_size;
...
/*#####################################################*/
void gui_put_item(void *pDisplay, s32 x_start, s32 y_start, s32 x_len, s32 y_len, u32 int_color, u32 border_color, CursorState cursor, GUI_PAINT_STYLE style, bool enabled)
{
