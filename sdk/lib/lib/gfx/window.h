...
class Window {
public:
	Window(void *ParentWindow, GI::Display::Display *ScreenDisplay);
	Window(GI::Display::Display *ScreenDisplay);
	~Window();
	void idle(tControlCommandData* control_comand);
	void idle();
	void* addChildren(u32 children_type, char *children_name);
	void* addChildren(u32 children_type, char *children_name, u32 tab_nr);
	...
	GI::Screen::Gfx::Button *addButton(char *name, u32 tabIndex);
	GI::Screen::Gfx::CheckBox *addCheckBox(char *name, u32 tabIndex);
	GI::Screen::Gfx::ListBox *addListBox(char *name, u32 tabIndex);
	GI::Screen::Gfx::Picturebox *addPictureBox(char *name, u32 tabIndex);
	GI::Screen::Gfx::TextBox *addTextBox(char *name, u32 tabIndex);
	GI::Screen::Gfx::ProgressBar *addProgressBar(char *name, u32 tabIndex);
	GI::Screen::Gfx::ScrollBar *addScrollBar(char *name, u32 tabIndex);
	GI::Screen::Gfx::KbdQwerty *addKbdQwerty(char *name, u32 tabIndex);
	GI::Screen::Gfx::Window *addWindow(char *name, u32 tabIndex);
	GI::Screen::Gfx::Window *addTabGroup(char *name, u32 tabIndex);
	...
	struct
	{
		...
		struct
		{
			s32 X;
			s32 Y;
			s32 ChildrenPosition_X;
			s32 ChildrenPosition_Y;
		}Position;
		struct
		{
			s32 X;
		...
		struct
		{
			...
			{
				s32 Y;
				s32 TabGroupSelectorSize;
			}Size;
			s32 TabGroupSelectorPosition;
			...
			u32 TabGroupTabsListNr;
			u32 OldTabGroupTabsListNr;
		}Header;
		struct
		{
			s32 X;
		...
		GI::Screen::Gfx::String *Caption;
		s32 HeaderTouchDownPointX;
		s32 HeaderTouchDownPointY;
		s32 WindowTouchDownPointX;
		s32 WindowTouchDownPointY;
		s32 WindowResizeTouchDownPointX;
		s32 WindowResizeTouchDownPointY;
		s32 WindowResizeTouchDownSizeX;
		s32 WindowResizeTouchDownSizeY;
...
private:
	void _newWindow(void *ParentWindow, GI::Display::Display *ScreenDisplay);
	void *_addChildren(u32 children_type, char *children_name, u32 tab_nr);
