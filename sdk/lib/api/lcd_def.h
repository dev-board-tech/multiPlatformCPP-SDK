...
//*****************************************************************************
extern LCD_TIMINGS lcd_DOGM128W_6_LANDSCAPE;//ST7565 controller
extern LCD_TIMINGS lcd_DOGM128W_6_LANDSCAPE_FLIP;//ST7565 controller
extern LCD_TIMINGS lcd_DOGM128W_6_PORTRAIT;//ST7565 controller
extern LCD_TIMINGS lcd_DOGM128W_6_PORTRAIT_FLIP;//ST7565 controller

extern LCD_TIMINGS lcd_UG2832HSWEG04_LANDSCAPE;//SSD1306 controller
extern LCD_TIMINGS lcd_UG2832HSWEG04_LANDSCAPE_FLIP;//SSD1306 controller
extern LCD_TIMINGS lcd_UG2832HSWEG04_PORTRAIT;//SSD1306 controller
extern LCD_TIMINGS lcd_UG2832HSWEG04_PORTRAIT_FLIP;//SSD1306 controller

extern LCD_TIMINGS lcd_UG9664HDDAG01_LANDSCAPE;//SSD1331 controller
extern LCD_TIMINGS lcd_UG9664HDDAG01_LANDSCAPE_FLIP;//SSD1331 controller
extern LCD_TIMINGS lcd_UG9664HDDAG01_PORTRAIT;//SSD1331 controller
extern LCD_TIMINGS lcd_UG9664HDDAG01_PORTRAIT_FLIP;//SSD1331 controller
...
extern LCD_TIMINGS lcd_MI0283_PORTRAIT;// ILI9341 or ST7789V controller
extern LCD_TIMINGS lcd_MI0283_LANDSCAPE;// ILI9341 or ST7789V controller
extern LCD_TIMINGS lcd_MI0283_PORTRAIT_FLIP;// ILI9341 or ST7789V controller
extern LCD_TIMINGS lcd_MI0283_LANDSCAPE_FLIP;// ILI9341 or ST7789V controller
...
extern LCD_TIMINGS lcd_fpga_640_480_60_crt_27_17_mhz;
extern LCD_TIMINGS lcd_fpga_640_480_60_display_24_20_mhz;
extern LCD_TIMINGS lcd_fpga_720_480_60_display_27_00_mhz;
extern LCD_TIMINGS lcd_fpga_800_600_60_display_40_00_mhz;
extern LCD_TIMINGS lcd_fpga_1024_768_60_display_65_00_mhz;
extern LCD_TIMINGS lcd_fpga_1280_720_60_display_74_25_mhz;
extern LCD_TIMINGS lcd_fpga_1400_1060_60_display_119_00_mhz;
extern LCD_TIMINGS lcd_fpga_1440_900_60_display_106_00_mhz;
extern LCD_TIMINGS lcd_fpga_1680_1050_60_display_146_25_mhz;
extern LCD_TIMINGS lcd_fpga_1920_1080_60_display_148_50_mhz;
//*****************************************************************************
//
...
{
	s32 FirstRowLength_Pixels;
	s32 FirstRowLength_Chars;
	s32 StringLengthWithSpecialChars_Chars;
	s32 StringLengthWithOutSpecialChars_Chars;
	s32 StringRowsMaxLength_Pixels;
	s32 StringColsHeight_Pixels;
	s32 StringColsHeight_Rows;
	s32 CharHeight_Pixels;
} StringProperties_t;
/*#####################################################*/
typedef struct {
	char name[12];
...
protected:
	...
	SysErr (*setBacklight_Ptr)(void *driverHandlerPtr, u8 value);
	bool (*copyScreen_Ptr)(void *driverHandlerPtr, void *pDisplayFrom, bool put_cursor,
				s32 X, s32 Y, u32 color);
	//void (*cacheClean_Ptr)(void *driverHandlerPtr, s32 x_start, s32 y_start,
				//ui x_len, ui y_len);
	void (*drawRectangle_Ptr)(void *driverHandlerPtr, si x_start, si y_start,
				ui x_len, ui y_len, bool fill, u32 color);
	void (*drawPixel_Ptr)(void *driverHandlerPtr, si X, si Y, u32 color);
	void (*copyRectangle16Bit_Ptr)(void *driverHandlerPtr, u16 *rgb_buffer,
				ui x1, ui y1, ui width,
				ui height);
	void (*copyRectangle24Bit_Ptr)(void *driverHandlerPtr, u8 *rgb_buffer,
				ui x1, ui y1, ui width,
				ui height);
	void (*copyRectangle32Bit_Ptr)(void *driverHandlerPtr, u8 *rgb_buffer,
				ui x1, ui y1, ui width,
				ui height);
	void (*drawHLine_Ptr)(void *driverHandlerPtr, si X1, ui X2,
				si Y, u8 width, u32 color);
	void (*drawVLine_Ptr)(void *driverHandlerPtr, si Y1, ui Y2,
				si X, u8 width, u32 color);
	void (*clear_Ptr)(void *driverHandlerPtr, u32 color);

	void (*setLuminosity_Ptr)(void *driverHandlerPtr, u8 luminosity);

	void (*drawTouchPoint_Ptr)(void *driverHandlerPtr, s32 X, s32 Y, u32 color);
	void (*drawCircle_Ptr)(void *driverHandlerPtr, si x, si y, ui _radius, bool fill, u32 color);
	void (*drawLine_Ptr)(void *driverHandlerPtr, si X1, si Y1, si X2, si Y2, u8 width, u32 color);
	void (*drawElipse_Ptr)(void *driverHandlerPtr, si x,si y,ui rx,ui ry, bool fill, u32 color);
	void (*drawTriangle_Ptr)(void *driverHandlerPtr, si  ax,si  ay,si  bx,si  by,si  cx,si  cy, bool fill, u32 color);
...
public:
	...
	SysErr setOn();
	SysErr setOff();
	SysErr setBacklight(u8 value);
	SysErr copyScreen(void *pDisplayFrom, bool put_cursor,
			s32 X, s32 Y, u32 color);
	SysErr cacheClean(s32 x_start, s32 y_start,
			ui x_len, ui y_len);
	SysErr drawRectangle(si x_start, si y_start,
			ui x_len, ui y_len, bool fill, u32 color);
	SysErr drawRectangle(si x_start, si y_start,
			ui x_len, ui y_len, bool fill, u32 color, ui cornerRadius);
	SysErr drawPixel(s32 X, s32 Y, u32 color);
	SysErr copyRectangle16Bit(u16 *rgb_buffer,
			ui x1, ui y1, ui width,
			ui height);
	SysErr copyRectangle24Bit(u8 *rgb_buffer,
			ui x1, ui y1, ui width,
			ui height);
	SysErr copyRectangle32Bit(u8 *rgb_buffer,
			ui x1, ui y1, ui width,
			ui height);
	SysErr drawHLine(si X1, ui X2,
			si Y, u8 width, u32 color);
	SysErr drawVLine(si Y1, ui Y2,
			si X, u8 width, u32 color);
	SysErr clear(u32 color);
	SysErr setLuminosity(u8 luminosity);

	SysErr drawTouchPoint(s32 X, s32 Y, u32 color);
	SysErr drawCircle(si x, si y, ui _radius, bool fill, u32 color);
	SysErr drawLine(si X1, si Y1, si X2, si Y2, u8 width, u32 color);
	SysErr drawElipse(si x,si y,ui rx,ui ry, bool fill, u32 color);
	SysErr drawTriangle(si  ax,si  ay,si  bx,si  by,si  cx,si  cy, bool fill, u32 color);
	int drawString(GI::string *string, si X, si Y, tRectangle *box, bool WordWrap, u32 foreColor, u32 color);
	int drawString(char *string, si X, si Y, tRectangle *box, bool WordWrap, u32 foreColor, u32 color);
    SysErr refresh();
