...
#include <device/ili9341_gpio.h>
#include <device/st7789v_gpio.h>
...
public:
	...
	GI::Storage::MmcSd *MMCSD[MMCSD_INTERFACE_COUNT];
#endif
	...
	GI::Display::Display *SCREEN[SCREENS_COUNT];
#ifdef USED_TOUCHSCREEN_1
	GI::Device::Cursor::USED_TOUCHSCREEN_1 *CURSORCTRL[1];
#endif
#endif
#if (USE_LWIP == 1)
	GI::Dev::Eth *LWIP[1];
