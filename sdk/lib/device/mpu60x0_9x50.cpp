...
GI::Device::Sensor::Mpu60x0_9x50::Mpu60x0_9x50(char *i2cPath, unsigned char icNr)
{
...
SysErr GI::Device::Sensor::Mpu60x0_9x50::sampleRateDivSet(unsigned char Value)
{
	if(!this)
...
SysErr GI::Device::Sensor::Mpu60x0_9x50::whoAmI()
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if(!I2C)
...
SysErr GI::Device::Sensor::Mpu60x0_9x50::setDlpfCfg(unsigned char value)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if(!I2C)
...
SysErr GI::Device::Sensor::Mpu60x0_9x50::setGyroSelfTest(bool X_test, bool Y_test, bool Z_test)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if(!I2C)
...
SysErr GI::Device::Sensor::Mpu60x0_9x50::setGyroFullScale(unsigned int scale)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if(!I2C)
...
SysErr GI::Device::Sensor::Mpu60x0_9x50::setAccelSelfTest(bool X_test, bool Y_test, bool Z_test)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if(!I2C)
...
SysErr GI::Device::Sensor::Mpu60x0_9x50::setAccelFullScale(unsigned int scale)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if(!I2C)
...
SysErr GI::Device::Sensor::Mpu60x0_9x50::getAccelData(signed short *X_Axis, signed short *Y_Axis, signed short *Z_Axis)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if(!I2C)
...
SysErr GI::Device::Sensor::Mpu60x0_9x50::getGyroData(signed short *X_Axis, signed short *Y_Axis, signed short *Z_Axis)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if(!I2C)
...
SysErr GI::Device::Sensor::Mpu60x0_9x50::getTempData(float *Temperature)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if(!I2C)
...
SysErr GI::Device::Sensor::Mpu60x0_9x50::setClockSel(unsigned char Value)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if(!I2C)
...
SysErr GI::Device::Sensor::Mpu60x0_9x50::setTempDis(bool Value)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if(!I2C)
...
SysErr GI::Device::Sensor::Mpu60x0_9x50::setCycle(bool Value)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if(!I2C)
...
SysErr GI::Device::Sensor::Mpu60x0_9x50::setSleep(bool Value)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if(!I2C)
...
SysErr GI::Device::Sensor::Mpu60x0_9x50::setDeviceReset(bool Value)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if(!I2C)
...
SysErr GI::Device::Sensor::Mpu60x0_9x50::setStbyZg(bool Value)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if(!I2C)
...
SysErr GI::Device::Sensor::Mpu60x0_9x50::setStbyYg(bool Value)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if(!I2C)
...
SysErr GI::Device::Sensor::Mpu60x0_9x50::setStbyXg(bool Value)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if(!I2C)
...
SysErr GI::Device::Sensor::Mpu60x0_9x50::setStbyZa(bool Value)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if(!I2C)
...
SysErr GI::Device::Sensor::Mpu60x0_9x50::setStbyYa(bool Value)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if(!I2C)
...
SysErr GI::Device::Sensor::Mpu60x0_9x50::setStbyXa(bool Value)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if(!I2C)
...
SysErr GI::Device::Sensor::Mpu60x0_9x50::setLpWakeCtrl(unsigned char Value)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if(!I2C)
...
SysErr GI::Device::Sensor::Mpu60x0_9x50::setBypassEnable(bool Value)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if(!I2C)
...
SysErr GI::Device::Sensor::Mpu60x0_9x50::testGyro(double *XtestResult, double *YtestResult, double *ZtestResult)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if(!I2C)
...
SysErr GI::Device::Sensor::Mpu60x0_9x50::testAccel(double *XtestResult, double *YtestResult, double *ZtestResult)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if(!I2C)
