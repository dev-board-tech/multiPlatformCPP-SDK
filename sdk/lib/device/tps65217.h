...
namespace Device {
namespace Pmic {
class Tps65217 : public GI::Sys::Pmic {
public:
    Tps65217(char *i2cPath);
    ~Tps65217();
    SysErr read(unsigned char regOffset, unsigned char* dest);
    SysErr write(unsigned char port_level, unsigned char regOffset, unsigned char dest_val, unsigned char mask);
