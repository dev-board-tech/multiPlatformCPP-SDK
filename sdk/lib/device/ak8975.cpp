...
GI::Device::Sensor::Ak8975::Ak8975(char *i2cPath, unsigned char icNr)
{
...
GI::Device::Sensor::Ak8975::~Ak8975()
{

}

SysErr GI::Device::Sensor::Ak8975::startMeasure() {
	if(!this)
...
SysErr GI::Device::Sensor::Ak8975::checkReady() {
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if(!I2C)
		return SYS_ERR_NO_ASSIGNED_DEVICE;
...
SysErr GI::Device::Sensor::Ak8975::getData(signed short *X_Axis, signed short *Y_Axis, signed short *Z_Axis) {
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if(!I2C)
		return SYS_ERR_NO_ASSIGNED_DEVICE;
...
SysErr GI::Device::Sensor::Ak8975::getMag(signed short *X_Axis, signed short *Y_Axis, signed short *Z_Axis) {
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	SysErr err;
...
/*SysErr GI::Device::Sensor::Ak8975::ak8975_display_result(AK8975_t *structure) {
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	signed short Xg = 0;
	signed short Yg = 0;
