...
#ifndef LIB_DEVICE_ILI9341_GPIO_H_
#define LIB_DEVICE_ILI9341_GPIO_H_
...
namespace Device {
namespace Display {
class Ili9341Gpio : public GI::Display::Display {
public:
	Ili9341Gpio(LCD_TIMINGS *timings, char *dataPins, char *writePin, char *readPin, char *rsPin, char *csPin, char *resetPin, char *backlightPin);
    ~Ili9341Gpio();
...
#include "ili9341_gpio.cpp"
#endif
/*#####################################################*/

#endif /* LIB_DEVICE_ILI9341_GPIO_H_ */
