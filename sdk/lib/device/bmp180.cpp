...
GI::Device::Sensor::Bmp180::Bmp180(char *i2cPath, unsigned char icNr)
{
...
GI::Device::Sensor::Bmp180::~Bmp180()
{

}

SysErr GI::Device::Sensor::Bmp180::readCalibration() {
	if(!this)
...
SysErr GI::Device::Sensor::Bmp180::readTemp(signed long *temp) {
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if(!I2C)
		return SYS_ERR_NO_ASSIGNED_DEVICE;
...
SysErr GI::Device::Sensor::Bmp180::readPressure(signed long *pressure, unsigned char oss) {
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if(!I2C)
		return SYS_ERR_NO_ASSIGNED_DEVICE;
...
*/
SysErr GI::Device::Sensor::Bmp180::getTemp(float *temp) {
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if(!I2C)
		return SYS_ERR_NO_ASSIGNED_DEVICE;
...
SysErr GI::Device::Sensor::Bmp180::getPressure(float *pressure, unsigned char oss) {
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	SysErr err;
	if((err = readCalibration()))
...
SysErr GI::Device::Sensor::Bmp180::getAltitude(float *altitude, unsigned char oss) {
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	float pressure = 0.0;
	SysErr err;
