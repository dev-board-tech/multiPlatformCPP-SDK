...
//#####################################################
#define MCP73871_RTC                 			(0x6F)
#define MCP73871_SRAM                			(0x6F)
#define MCP73871_EEP                 			(0x57)
//-----------------------------------------------------
...
public:
    ...
    SysErr readRam(unsigned char WriteAddr, unsigned char *pBuffer, unsigned char NumByteToWrite);
    SysErr writeRam(unsigned char ReadAddr, unsigned char *pBuffer, unsigned char NumByteToRead);
    SysErr readEep(unsigned char WriteAddr, unsigned char *pBuffer, unsigned char NumByteToRead);
    SysErr writeEep(unsigned char ReadAddr, unsigned char *pBuffer, unsigned char NumByteToWrite);
    ...
    GI::string *readTime(char *format);
    GI::string *timeStr;
    GI::IO *hwIo;
private:
