...
GI::Device::Cursor::Stmpe811::Stmpe811(GI::Display::Display *pDisplay, char *i2cpath, char *irqPinPath)
{
	if (!pDisplay || !i2cpath)
		return;
...
GI::Device::Cursor::Stmpe811::~Stmpe811()
{
	if(!this)
		return;
	reset();
...
tControlCommandData *GI::Device::Cursor::Stmpe811::idle()
{
	...
	if(cursor_ctl.Cursor == Cursor_Down)
	{
		cursor_ctl.xOnLeftMousPress = cursor_ctl.X;
		cursor_ctl.yOnLeftMousPress = cursor_ctl.Y;
	}
	cursor_ctl.xOffset = cursor_ctl.X - cursor_ctl.xOnLeftMousPress;
	cursor_ctl.yOffset = cursor_ctl.Y - cursor_ctl.yOnLeftMousPress;
	return &cursor_ctl;
}

SysErr GI::Device::Cursor::Stmpe811::write(unsigned char reg, unsigned char data)
{
	if(!this)
...
SysErr GI::Device::Cursor::Stmpe811::read(unsigned char reg, unsigned char *data)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if (!twiStruct)
...
SysErr GI::Device::Cursor::Stmpe811::readMultiple(unsigned char reg,
...
SysErr GI::Device::Cursor::Stmpe811::reset()
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	unsigned char data;
 ...
 */
SysErr GI::Device::Cursor::Stmpe811::readId(unsigned short id)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
 ...
 * @retval None
 */
SysErr GI::Device::Cursor::Stmpe811::enableGlobalIt()
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	unsigned char tmp = 0;
 ...
 * @retval None
 */
SysErr GI::Device::Cursor::Stmpe811::disableGlobalIt()
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	unsigned char tmp = 0;
 ...
 * @retval None
 */
SysErr GI::Device::Cursor::Stmpe811::enableItSource(unsigned char source)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	unsigned char tmp = 0;
 ...
 * @retval None
 */
SysErr GI::Device::Cursor::Stmpe811::disableItSource(unsigned char source)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	unsigned char tmp = 0;
 ...
 * @retval None
 */
SysErr GI::Device::Cursor::Stmpe811::setItPolarity(unsigned char polarity)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	unsigned char tmp = 0;
 ...
 * @retval None
 */
SysErr GI::Device::Cursor::Stmpe811::setItType(unsigned char type)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	unsigned char tmp = 0;
 ...
 */
SysErr GI::Device::Cursor::Stmpe811::globalItStatus(unsigned char source, bool *status)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	unsigned char tmp = 0;
 ...
 * @retval The checked Global interrupt source status.
 */
SysErr GI::Device::Cursor::Stmpe811::getGlobalItStatus(unsigned char source, unsigned char *status)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	unsigned char tmp = 0;
 ...
 * @retval None
 */
SysErr GI::Device::Cursor::Stmpe811::clearGlobalIt(unsigned char source)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
 ...
 * @retval None
 */
SysErr GI::Device::Cursor::Stmpe811::ioStart(unsigned char ioPin)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	unsigned char mode;
 ...
 */
SysErr GI::Device::Cursor::Stmpe811::ioConfig(unsigned char ioPin, GI::Device::Cursor::Stmpe811::gpioMode_e ioMode)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	SysErr err;
 ...
 * @retval None
 */
SysErr GI::Device::Cursor::Stmpe811::ioInitPin(unsigned char ioPin, unsigned char direction)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	unsigned char tmp = 0;
 ...
 * @retval None
 */
SysErr GI::Device::Cursor::Stmpe811::ioDisableAf(unsigned char ioPin)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	unsigned char tmp = 0;
 ...
 * @retval None
 */
SysErr GI::Device::Cursor::Stmpe811::ioEnableAf(unsigned char ioPin)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	unsigned char tmp = 0;
 ...
 * @retval None
 */
SysErr GI::Device::Cursor::Stmpe811::ioSetEdgeMode(unsigned char ioPin, unsigned char Edge)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
 ...
 * @retval None
 */
SysErr GI::Device::Cursor::Stmpe811::ioWritePin(unsigned char ioPin, unsigned char pinState)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	SysErr err = SYS_ERR_OK;
 ...
 */
SysErr GI::Device::Cursor::Stmpe811::ioReadPin(unsigned char ioPin, unsigned char *ioPinStatus)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	unsigned char tmp = 0;
 ...
 * @retval None
 */
SysErr GI::Device::Cursor::Stmpe811::ioEnableIt()
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	SysErr err;
 ...
 * @retval None
 */
SysErr GI::Device::Cursor::Stmpe811::ioDisableIt()
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	SysErr err;
 ...
 * @retval None
 */
SysErr GI::Device::Cursor::Stmpe811::ioEnablePinIt(unsigned char ioPin)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	unsigned char tmp = 0;
 ...
 * @retval None
 */
SysErr GI::Device::Cursor::Stmpe811::ioDisablePinIt(unsigned char ioPin)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	unsigned char tmp = 0;
 ...
 */
SysErr GI::Device::Cursor::Stmpe811::ioItStatus(unsigned char ioPin, unsigned char *ioItPinStatus)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	unsigned char tmp = 0;
 ...
 * @retval None
 */
SysErr GI::Device::Cursor::Stmpe811::ioClearIt(unsigned char ioPin)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	SysErr err;
...
SysErr GI::Device::Cursor::Stmpe811::readTouch(signed short *x, signed short *y, bool applyScale)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	SysErr err;
...
void GI::Device::Cursor::Stmpe811::touchCalibrate()
{
	if(!this)
		return;
	...
	//pDisplay->cacheClean(0, 0, pDisplay->LcdTimings->X, pDisplay->LcdTimings->Y);
	pDisplay->refresh();
