...
GI::Device::Sensor::Mpl3115a2::Mpl3115a2(char *i2cPath)
{
...
GI::Device::Sensor::Mpl3115a2::~Mpl3115a2()
{

}

SysErr GI::Device::Sensor::Mpl3115a2::regRead(unsigned char reg, unsigned char *data, unsigned char len)
{
	if(!this)
...
SysErr GI::Device::Sensor::Mpl3115a2::regWrite(unsigned char reg, unsigned char *data, unsigned char len)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if(!I2C)
...
SysErr GI::Device::Sensor::Mpl3115a2::getAltTemp(unsigned char oversample, float *pressure, float *altitude, float *temperature)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
