...
GI::Device::Sensor::L3gd20::L3gd20(char *spiPath)
{
...
GI::Device::Sensor::L3gd20::~L3gd20()
{

}

SysErr GI::Device::Sensor::L3gd20::writeRegs(unsigned char* pBuffer,
...
SysErr GI::Device::Sensor::L3gd20::readRegs(unsigned char* pBuffer,
...
SysErr GI::Device::Sensor::L3gd20::filterCfg(unsigned char cfg)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if (!SPI)
...
SysErr GI::Device::Sensor::L3gd20::filterEn(bool state)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if (!SPI)
 ...
 * @retval None
 */
SysErr GI::Device::Sensor::L3gd20::read(float *X, float *Y, float *Z)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if (!SPI)
