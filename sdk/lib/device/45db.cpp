...
GI::Device::Storage::Flash45db::Flash45db(char *spiPath)
{
    GI::Dev::DevRequest::request(spiPath, &SPI);
}

GI::Device::Storage::Flash45db::~Flash45db()
{

}

SysErr GI::Device::Storage::Flash45db::readStatus(unsigned char *status)
{
	if(!this)
...
SysErr GI::Device::Storage::Flash45db::enterSleep()
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
    if(!SPI)
...
SysErr GI::Device::Storage::Flash45db::resumeSleep()
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
    if(!SPI)
...
SysErr GI::Device::Storage::Flash45db::writeBuff(unsigned char buffNr, unsigned int pageNr, unsigned char *data)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
    if(!SPI)
...
SysErr GI::Device::Storage::Flash45db::writeFromBuffer(unsigned char buffNr, unsigned int pageNr)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
    if(!SPI)
...
SysErr GI::Device::Storage::Flash45db::pageErase(unsigned int pageNr)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
    if(!SPI)
...
SysErr GI::Device::Storage::Flash45db::write(unsigned char buffNr, unsigned int pageNr, unsigned char *data)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
    if(!SPI)
...
SysErr GI::Device::Storage::Flash45db::read(unsigned int pageNr, unsigned char *data, unsigned int size)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
    if(!SPI)
