...
GI::Device::Storage::Eep24c::Eep24c(char *i2cPath, unsigned char icNr, Sizes devSize)
{
...
GI::Device::Storage::Eep24c::~Eep24c()
{

}

SysErr GI::Device::Storage::Eep24c::write(unsigned long addr, unsigned char *buff, unsigned long len)
{
	if(!this)
...
SysErr GI::Device::Storage::Eep24c::read(unsigned long addr, unsigned char *buff, unsigned long len)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
    unsigned char ctrl_byte = 0x50;
