...
GI::Device::Cursor::Ft5x06::~Ft5x06()
{

}

GI::Device::Cursor::Ft5x06::Ft5x06(GI::Display::Display *pDisplay, char *i2cpath, char *irqPinPath)
{
	if(!pDisplay)
		return;
...
tControlCommandData *GI::Device::Cursor::Ft5x06::idle()
{
	...
	if(cursor_ctl.Cursor == Gfx_IntTouch_MouseDn)
	{
...
void GI::Device::Cursor::Ft5x06::touchCalibrate()
{
