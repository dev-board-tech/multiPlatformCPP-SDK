...
GI::Device::Sensor::Mpr121::Mpr121(char *i2cPath, char *irqPath, unsigned char icNr)
{
...
GI::Device::Sensor::Mpr121::~Mpr121()
{

}

SysErr GI::Device::Sensor::Mpr121::readShort(unsigned char reg, unsigned short *return_data)
{
	if(!this)
...
SysErr GI::Device::Sensor::Mpr121::read(unsigned char reg, unsigned char *return_data)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if(!I2C)
...
SysErr GI::Device::Sensor::Mpr121::write(unsigned char reg, unsigned char data)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if(!I2C)
...
SysErr GI::Device::Sensor::Mpr121::idle(mpr121_ret_t *return_keys)
{
	if(!this)
		return SYS_ERR_INVALID_HANDLER;
	if(!I2C)
