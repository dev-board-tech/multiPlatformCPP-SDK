...
GI::Device::Sensor::Hih613x::Hih613x(char *i2cPath)
{
...
GI::Device::Sensor::Hih613x::~Hih613x()
{

}

SysErr GI::Device::Sensor::Hih613x::get(unsigned char *status, float *hum, float *temp) {
	if(!this)
