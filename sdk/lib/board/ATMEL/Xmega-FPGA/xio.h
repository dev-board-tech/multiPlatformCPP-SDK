...
{
	register8_t LCD_CTRL;
	register8_t LCD_H_RES_LOW;
	register8_t LCD_H_RES_HIGH;
	register8_t LCD_H_PULSE_WIDTH;
	register8_t LCD_H_BACK_PORCH;
	register8_t LCD_H_FRONT_PORCH;
	register8_t LCD_V_RES_LOW;
	register8_t LCD_V_RES_HIGH;
	register8_t LCD_V_PULSE_WIDTH;
	register8_t LCD_V_BACK_PORCH;
	register8_t LCD_V_FRONT_PORCH;
	register8_t LCD_PIXEL_SIZE;
	register8_t LCD_BASE_ADDR_BYTE0;
	register8_t LCD_BASE_ADDR_BYTE1;
	register8_t LCD_BASE_ADDR_BYTE2;
	register8_t LCD_BASE_ADDR_BYTE3;
} FPGA_LCD_t;
...
{
	FPGA_LCD_t LCD;
	register8_t GFX_ACCEL_CMD;
	register8_t GFX_ACCEL_CLIP_X_MIN_L;
	register8_t GFX_ACCEL_CLIP_X_MIN_H;
	register8_t GFX_ACCEL_CLIP_X_MAX_L;
	register8_t GFX_ACCEL_CLIP_X_MAX_H;
	register8_t GFX_ACCEL_CLIP_Y_MIN_L;
	register8_t GFX_ACCEL_CLIP_Y_MIN_H;
	register8_t GFX_ACCEL_CLIP_Y_MAX_L;
	register8_t GFX_ACCEL_CLIP_Y_MAX_H;
	register8_t GFX_ACCEL_COLOR_BYTE_0;
	register8_t GFX_ACCEL_COLOR_BYTE_1;
	register8_t GFX_ACCEL_COLOR_BYTE_2;
	register8_t GFX_ACCEL_COLOR_BYTE_3;
} FPGA_GFX_ACCEL_t;
...
/* CPU - CPU registers */
#define FPGA_CPU_CCP  _SFR_MEM8(0x0034)
#define FPGA_CPU_RAMPD  _SFR_MEM8(0x0038)
#define FPGA_CPU_RAMPX  _SFR_MEM8(0x0039)
#define FPGA_CPU_RAMPY  _SFR_MEM8(0x003A)
#define FPGA_CPU_RAMPZ  _SFR_MEM8(0x003B)
#define FPGA_CPU_EIND  _SFR_MEM8(0x003C)
#define FPGA_CPU_SPL  _SFR_MEM8(0x003D)
#define FPGA_CPU_SPH  _SFR_MEM8(0x003E)
#define FPGA_CPU_SREG  _SFR_MEM8(0x003F)
