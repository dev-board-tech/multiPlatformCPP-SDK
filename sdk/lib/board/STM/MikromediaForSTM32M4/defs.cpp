...
ioSetCfgGpio(touch_drive_a,"touchdrva",	pin_mux_convert_to_pin(IOB,  8), CfgGpio::GPIO_OUT_PUSH_PULL	, false, false, 1);
ioSetCfgGpio(touch_drive_b,"touchdrvb",	pin_mux_convert_to_pin(IOB,  9), CfgGpio::GPIO_OUT_PUSH_PULL	, false, false, 1);
ioSetCfgGpio(touch_xl,"touchxl",		pin_mux_convert_to_pin(IOE,  0), CfgGpio::GPIO_AIN				, false, false, 1);
ioSetCfgGpio(touch_yd,"touchyd",		pin_mux_convert_to_pin(IOE,  0), CfgGpio::GPIO_AIN				, false, false, 1);
